...
const TRANSLATIONS = {
  ...
  french: {
    ...
    editorDesc:
      "Modifiez le contenu de votre devoir ci-dessous (commence à la page 2)",
    reset: "Réinitialiser",
    words: "Mots",
  ...
  german: {
    ...
    pageSubtitle:
      "Erstellen Sie professionelle Aufgaben mit automatischer Formatierung",
    ...
    editorDesc:
      "Bearbeiten Sie Ihren Aufgabeninhalt unten (beginnt auf Seite 2)",
    reset: "Zurücksetzen",
    words: "Wörter",
  ...
  russian: {
    ...
    pageSubtitle:
      "Создавайте профессиональные задания с автоматическим форматированием",
    ...
    editorDesc:
      "Редактируйте содержание вашего задания ниже (начинается со страницы 2)",
    reset: "Сбросить",
    words: "Слова",
...
const REFERENCE_FORMATS = {
  ...
  mla: {
    ...
    website:
      'Author Last Name, First Name. "Title of Page." Site Name, Date, URL.',
  },
};
...
export default function AssignmentFormatPage() {
  ...
  // Format settings
  const [fontStyle, setFontStyle] = useState<"times" | "arial" | "calibri">(
    "times",
  );
  const [lineSpacing, setLineSpacing] = useState<"1.0" | "1.5" | "2.0">("1.5");
  const [pageNumbering, setPageNumbering] = useState<"bottom" | "top" | "none">(
    "bottom",
  );
  const [pageNumStart, setPageNumStart] = useState<"cover" | "content">(
    "content",
  );
...
`;
  ...
  const handleDownloadPDF = () => {
    ...
    const pageBreak = "\n\n\n--- PAGE BREAK ---\n\n\n";
    const _fullContent = coverPage + pageBreak + content;
    ...
    <div className="container py-8 md:py-12 max-w-7xl">
      <div className="mb-6 flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3 bg-card border-2 rounded-lg p-3">
          ...
          <Select
            value={language}
            onValueChange={(value) => setLanguage(value as LanguageMode)}
          >
          ...
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription className="text-sm">
                This information will appear on the standalone cover page (Page
                1)
              </CardDescription>
            </CardHeader>
          ...
          <Card className="border-2">
            <CardHeader>
              <div className="flex items-center gap-2">
                <img
                  src="/assets/generated/font-selector-icon-transparent.dim_24x24.png"
                  alt="Format"
                  className="h-5 w-5"
                />
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    value={pageNumbering}
                    onValueChange={(value) => setPageNumbering(value as any)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                {pageNumbering !== "none" && (
                  <div>
                    ...
                    <Select
                      value={pageNumStart}
                      onValueChange={(value) => setPageNumStart(value as any)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm text-muted-foreground bg-muted/50 p-3 rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-medium">
                    {t.estPages}:{" "}
                    <span className="text-foreground">{pageCount + 1}</span>{" "}
                    <span className="text-xs">(+1 cover)</span>
                  </span>
                </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="space-y-1">
                  {SUBJECT_HEADINGS.science.map((heading) => (
                    <Button
                      key={heading}
                      variant="ghost"
                      size="sm"
              ...
              <div>
                ...
                <div className="space-y-1">
                  {SUBJECT_HEADINGS.computerScience.map((heading) => (
                    <Button
                      key={heading}
                      variant="ghost"
                      size="sm"
              ...
              <div>
                ...
                <div className="space-y-1">
                  {SUBJECT_HEADINGS.artsCommerce.map((heading) => (
                    <Button
                      key={heading}
                      variant="ghost"
                      size="sm"
