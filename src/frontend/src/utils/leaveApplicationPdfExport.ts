...
function getLanguageLabel(language: string): {
  ...
  > = {
    English: {
      ...
      signOffLabel: "Yours sincerely,",
      classLabel: "Class/Roll No.",
      parentSigLabel: "Parent's / Guardian's Signature",
    ...
    Urdu: {
      ...
      toLabel: "بخدمت",
      subjectLabel: "موضوع",
      signOffLabel: "آپ کا/کی مخلص،",
      classLabel: "جماعت/رول نمبر",
      parentSigLabel: "والدین / سرپرست کے دستخط",
    ...
    Hindi: {
      ...
      toLabel: "सेवा में",
      subjectLabel: "विषय",
      signOffLabel: "आपका/आपकी आज्ञाकारी,",
      classLabel: "कक्षा/रोल नं.",
      parentSigLabel: "अभिभावक के हस्ताक्षर",
    ...
    Arabic: {
      ...
      signOffLabel: "مع التقدير،",
      classLabel: "الفصل/رقم القيد",
      parentSigLabel: "توقيع ولي الأمر",
    ...
    French: {
      ...
      toLabel: "À",
      subjectLabel: "Objet",
      signOffLabel: "Veuillez agréer mes salutations distinguées,",
      classLabel: "Classe/N° de rôle",
      parentSigLabel: "Signature du parent/tuteur",
    ...
    Spanish: {
      ...
      toLabel: "A",
      subjectLabel: "Asunto",
      signOffLabel: "Atentamente,",
      classLabel: "Clase/N° de lista",
      parentSigLabel: "Firma del padre/tutor",
    ...
    German: {
      ...
      signOffLabel: "Mit freundlichen Grüßen,",
      classLabel: "Klasse/Matrikelnr.",
      parentSigLabel: "Unterschrift des Elternteils/Erziehungsberechtigten",
    ...
    Portuguese: {
      ...
      signOffLabel: "Atenciosamente,",
      classLabel: "Turma/N° de chamada",
      parentSigLabel: "Assinatura do pai/responsável",
    ...
    Bengali: {
      ...
      toLabel: "বরাবর",
      subjectLabel: "বিষয়",
      signOffLabel: "আপনার বিশ্বস্ত,",
      classLabel: "শ্রেণী/রোল নং",
      parentSigLabel: "অভিভাবকের স্বাক্ষর",
    ...
    Punjabi: {
      ...
      toLabel: "ਸੇਵਾ ਵਿੱਚ",
      subjectLabel: "ਵਿਸ਼ਾ",
      signOffLabel: "ਤੁਹਾਡਾ/ਤੁਹਾਡੀ ਵਿਸ਼ਵਾਸਪਾਤਰ,",
      classLabel: "ਜਮਾਤ/ਰੋਲ ਨੰ.",
      parentSigLabel: "ਮਾਤਾ-ਪਿਤਾ / ਸਰਪ੍ਰਸਤ ਦੇ ਦਸਤਖਤ",
    ...
    Turkish: {
      ...
      toLabel: "Kime",
      subjectLabel: "Konu",
      signOffLabel: "Saygılarımla,",
      classLabel: "Sınıf/Öğrenci No.",
      parentSigLabel: "Veli / Vasi İmzası",
    ...
    Persian: {
      ...
      toLabel: "به",
      subjectLabel: "موضوع",
      signOffLabel: "با احترام،",
      classLabel: "کلاس/شماره دانش‌آموزی",
      parentSigLabel: "امضای والدین / سرپرست",
    ...
    Russian: {
      ...
      toLabel: "Кому",
      subjectLabel: "Тема",
      signOffLabel: "С уважением,",
      classLabel: "Класс/№ студ. билета",
      parentSigLabel: "Подпись родителя/опекуна",
    ...
    Italian: {
      ...
      signOffLabel: "Distinti saluti,",
      classLabel: "Classe/N° di matricola",
      parentSigLabel: "Firma del genitore/tutore",
    ...
    Dutch: {
      ...
      signOffLabel: "Met vriendelijke groet,",
      classLabel: "Klas/Studentnr.",
      parentSigLabel: "Handtekening ouder/voogd",
    ...
    Polish: {
      ...
      toLabel: "Do",
      subjectLabel: "Temat",
      signOffLabel: "Z poważaniem,",
      classLabel: "Klasa/Nr indeksu",
      parentSigLabel: "Podpis rodzica/opiekuna",
    ...
    Swedish: {
      ...
      toLabel: "Till",
      subjectLabel: "Ämne",
      signOffLabel: "Med vänliga hälsningar,",
      classLabel: "Klass/Studentnr.",
      parentSigLabel: "Förälder/vårdnadshavares underskrift",
...
export async function exportLeaveApplicationAsPdf(
  params: LetterParams,
): Promise<void> {
  const {
    studentName,
  ...
  const recipientTitle =
    recipientTitles[recipientType]?.[language] ??
    recipientTitles[recipientType]?.English ??
    "The Principal";
  ...
  const bodyDurationMap: Record<string, string> = {
    ...
    Hindi:
      durationType === "range"
        ...
        : "",
    Arabic:
      durationType === "range" ? `مدة الإجازة الإجمالية ${diffDays} أيام.` : "",
    French:
      durationType === "range"
    ...
    Portuguese:
      durationType === "range"
        ...
        : "",
    Bengali:
      durationType === "range" ? `আমার ছুটির মোট সময়কাল ${diffDays} দিন হবে।` : "",
    Punjabi:
      durationType === "range"
